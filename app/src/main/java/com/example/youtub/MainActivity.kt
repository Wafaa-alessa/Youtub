...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        youTubeView = findViewById(R.id.youtube) //true
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putInt("currentVideo", nowVideo)
    ...
    private fun initialize(){
        val recyclerView: RecyclerView = findViewById(R.id.recyc)
        recyclerView.adapter = VideoAdapter(videos, youTubeplayer)
